...
- System prompt instructs the model to:
  ...
  - Internally rate responses on a rubric (ELPAC-aligned levels 1–4).
...
- **Proficiency levels** follow the ELPAC framework (levels 1–4: Beginning, Somewhat Developed, Moderately Developed, Well Developed).
